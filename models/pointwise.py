...
class PointwiseNet(BaseEstimator):
    """
    ...
    def _build_model(self):
        ...
        self.model = tf.keras.models.Model(input_layer, nn, name='PointwiseNet')
    ...
    def _def_cost(self, y_actual, y_pred):
        """
        Pointwise loss (just RMSE loss)
        """
        return tf.losses.mean_squared_error(y_actual, y_pred)
