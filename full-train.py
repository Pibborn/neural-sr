...
if __name__ == '__main__':
    train_gen = DatasetGenerator(wandb.config.dataset, split='train', query=wandb.config.query,  pairwise=wandb.config['pairwise'], limit_dataset_size=wandb.config.limit_dataset_size)
